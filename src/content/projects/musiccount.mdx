...
<div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
  <div className="order-1">
    <ThemeAwareImage
      light={{
        src: "/portfolio/musiccount-comparison-light-thumb.webp",
        lightboxSrc: "/portfolio/musiccount-comparison-light.webp",
      }}
      dark={{
        src: "/portfolio/musiccount-comparison-dark-thumb.webp",
        lightboxSrc: "/portfolio/musiccount-comparison-dark.webp",
      }}
      alt="Comparison view"
      loading="lazy"
      width={1920}
